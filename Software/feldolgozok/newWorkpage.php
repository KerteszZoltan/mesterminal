...
print $customer_count = $_POST['customer_count'];
print $manufactured_count = $_POST['manufactured_count'];
print $pass_count = $_POST['pass_count'];
print $fail_count = $_POST['fail_count'];
print $status = $_POST['status'];

print $sql ="INSERT INTO `order` (barcode, order_type_ID, customer_number, site_id, product_id, customer_count, manufactured_count, pass_count, fail_count, order_status_ID) 
       VALUES ('{$barcode}','{$order_type}', '{$customer_number}', '{$site}', '{$product}', '{$customer_count}', '{$manufactured_count}', '{$pass_count}', '{$fail_count}', '{$status}')";
