...
--
-- Gép: localhost:3306
-- Létrehozás ideje: 2021. Aug 19. 07:01
...
(1, '0', 1, 'VRR20210810T', 2, 1, 10, 10, 10, 2, 2);
...
INSERT INTO `order_manufacturing_step` (`ID`, `barcode`, `order_ID`, `manufacturing_step_ID`, `expected_count`, `pass_count`, `fail_count`, `normal_time`, `preparation_time`, `unit_of_time`) VALUES
(1, 'MUV0399-3', 1, 1, 0, 0, 0, 0, 0, 0);
...
INSERT INTO `order_manufacturing_step_machine_error` (`ID`, `order_manufacturing_step_ID`, `error_ID`, `machine_ID`, `machine_tool_ID`, `date_start`, `date_end`, `user_ID`, `description`) VALUES
(1, 1, 2, 4, 2, '2021-08-18 11:10:00', '2021-08-18 12:00:00', 2, 'teszt');
...
INSERT INTO `order_manufacturing_step_machine_tool` (`ID`, `order_manufacturing_step_ID`, `machine_ID`, `machine_tool_ID`) VALUES
(1, 1, 17, 1);
