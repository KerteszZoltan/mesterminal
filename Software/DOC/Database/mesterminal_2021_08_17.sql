...
--
-- Gép: localhost:3306
-- Létrehozás ideje: 2021. Aug 17. 09:40
...
INSERT INTO `order_manufacturing_step` (`ID`, `order_ID`, `manufacturing_step_ID`, `expected_count`, `pass_count`, `fail_count`, `normal_time`, `preparation_time`, `unit_of_time`) VALUES
(1, 3, 1, 1, 1, 0, 3, 0.1, 4),
(2, 3, 3, 0, 0, 0, 0.2, 0, 0.2),
(3, 3, 4, 0, 0, 0, 0, 60, 0);
