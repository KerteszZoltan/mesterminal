...
print '
<form action="feldolgozok/newOperation.php" method="POST">
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Művelet megnevezés</span>
  <input type="text" name="operation_name" class="form-control" placeholder="pl. Termelő tevékenység " required>
  <input type="submit" value="Rögzítés" class="btn btn-primary">
</div>
</form>
';
include_once("lists/listOperations.php");
}
else{
